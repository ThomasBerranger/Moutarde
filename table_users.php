...
$membre = $bdd->query("SELECT * FROM membres"); //Récupère toutes les infos pour afficher les reservations bretagne nord
                 ...
                 <div class="main-content-inner">
                     <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                         <ul class="breadcrumb">
                             ...
                             <li class="active">Tableau utilisateurs</li>
                         </ul><!-- /.breadcrumb -->
                     </div>
                                             ...
                                             <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                                                 ...
                                                 <tbody>
                                                     <tr>
                                                       ...
                                                       {
                                                        if ($donnees['mail']!="admin@gmail.com") {
                                                       ?>
                                                         ...
                                                         <td><?php echo $donnees['news_letter']; ?></td>

              ...
              if($newmdp == $newmdp2)
              {
                ...
                if (isset($_POST['newmail']) and !empty($_POST['newmail']))
                {
                  ...
                  if(filter_var($newmail, FILTER_VALIDATE_EMAIL))
                    ...
                    $verif_mail_actuel = $dbh->prepare("SELECT mail FROM membres WHERE id = ?");
                    ...
                    if($mailexist==0 or $newmail==$verif_mail_actuel['mail'])
                    {
                        ...
                        if (isset($_POST['newmail']) and !empty($_POST['newmail']))
                        {
                            $insertmail = $dbh->prepare("UPDATE membres SET mail = ? WHERE id = ?");
                        ...
                        if(isset($_POST['newprenom']) and !empty($_POST['newprenom']))
                        {
                            ...
                            $insertprenom = $dbh->prepare("UPDATE membres SET prenom = ? WHERE id = ?");
                        ...
                        if(isset($_POST['newnom']) and !empty($_POST['newnom']))
                        {
                            ...
                            $insertnom = $dbh->prepare("UPDATE membres SET nom = ? WHERE id = ?");
          ...
          <div class="container">
              ...
              <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                  <ul class="nav navbar-nav navbar-right">
                      ...
                      <li>
                          <a class="page-scroll" href=<?php echo "index.php?id=".$_SESSION['id']."#page-top"?>>Accueil</a>
                      </li>
                      <li>
                          <a class="page-scroll" href=<?php echo "index.php?id=".$_SESSION['id']."#circuits"?>>Circuits</a>
                      </li>
                      <li>
                          <a class="page-scroll" href=<?php echo "index.php?id=".$_SESSION['id']."#faq"?>>FAQ</a>
                      </li>
                      <li>
                          <a class="page-scroll" href=<?php echo "index.php?id=".$_SESSION['id']."#contact"?>>Contact</a>
                      </li>
                      <li class="dropdown">

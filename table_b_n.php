...
$reservations = $bdd->query("SELECT * FROM reservations"); //Récupère toutes les infos pour afficher les reservations bretagne nord
...
if(isset($_SESSION['id']))
{
 ...
 <html lang="en">
     <head>
         ...
         <meta charset="utf-8" />
         <title>Tableau reservation bretagne nord</title>
                 ...
                 <div class="main-content-inner">
                     <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                         <ul class="breadcrumb">
                             ...
                             <li class="active">Tableau reservation bretagne nord</li>
                         </ul><!-- /.breadcrumb -->
                     </div>
                     ...
                     <div class="page-content">
                         ...
                         <div class="page-header">
                             <h1>
                                 Tableau reservation bretagne nord
                             </h1>
                         </div><!-- /.page-header -->
                                             ...
                                             <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                                                 ...
                                                 <tbody>
                                                     <tr>
                                                       ...
                                                       {
                                                       if ($nouvelle_res != $donnees['num_res'] && $donnees['destination'] == "Bretagne du nord") {
                                                       ?>

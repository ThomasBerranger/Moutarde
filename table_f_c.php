...
if(isset($_SESSION['id']))
{
 ...
 <html lang="en">
     <head>
         ...
         <meta charset="utf-8" />
         <title>Tableau reservation Franche-Comté</title>
                 ...
                 <div class="main-content-inner">
                     <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                         <ul class="breadcrumb">
                             ...
                             <li class="active">Tableau reservation Franche-Comté</li>
                         </ul><!-- /.breadcrumb -->
                     </div>
                     ...
                     <div class="page-content">
                         ...
                         <div class="page-header">
                             <h1>
                                 Tableau reservation Franche-Comté
                             </h1>
                         </div><!-- /.page-header -->
                                             ...
                                             <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                                                 ...
                                                 <tbody>
                                                     <tr>
                                                       ...
                                                       {
                                                       if ($nouvelle_res != $donnees['num_res'] && $donnees['destination'] == "Franche-Comte") {
                                                       ?>

...
<html>
  <head>
    <meta charset="utf-8">
    <title>Bretagne du sud</title>
  </head>

          <!-- Theme CSS -->

        <meta http-equiv="X-UA-Compatible" content="IE=edge">
        <meta name="description" content="Bretagne sud" />
    ...
    <div class="container">
                                <div class="row">
                                    <div class="col-lg-12 text-center">
                                        <h2 class="section-heading">Bretagne Sud</h2> </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-12">
                                        <!-- Mon carousel -->
                                        <div id="myCarousel" class="carousel slide" data-ride="carousel">
                                            ...
                                            <!-- Wrapper for slides -->
                                             <div class="carousel-inner" role="listbox">
                                                <div class="item active"> <img src="./img/bretagnesud/bresud.jpg" alt="Bretagne sud" class="image-responsive"> </div>
                                                <div class="item"> <img src="./img/bretagnesud/bresud2.jpg" alt="bretagne sud" class="image-responsive"> </div>
                                            </div>
                                        </div>
                                        <div class="timeline-heading">
                                            <h4 class="subheading">Présentation</h4> </div>
                                        <div class="timeline-body">
                                            <p class="text-muted">Le charme de la Bretagne se mesure à l’audace de ses vieilles pierres. Ici une longère typique, là une chapelle restaurée à l’identique… le patrimoine bâti donne de l’allure aux villes qui l’abritent, et offre un témoignage vivant à ses visiteurs.</p>
                                        </div>
                    ...
                    <div class="row" style="padding-top: 5vh;margin: auto;text-align: center;">
                            ...
                            <div class="col-md-4">
                                ...
                                <h3>Il reste de la place !</h3> </div>
                            <div class="col-md-4">

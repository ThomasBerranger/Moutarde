...
if(isset($_SESSION['id']))
{
 ...
 <html lang="en">
 	<head>
 		...
 		<meta charset="utf-8" />
 		<title>Calendrier bretagne sud</title>
          ...
          <li class="">
 			...
 			<div class="main-content">
              ...
              <li>
 							...
 							<li class="active">Calendrier Bretagne du sud</li>
 						</ul><!-- /.breadcrumb -->
                                  ...
                                  <table>
                                      ...
                                      <tr>
                                          ...
                                          <td
                                            ...
                                            $reservation_bretagne_sud = $bdd->prepare("SELECT * FROM reservations WHERE destination=?");
                                            $reservation_bretagne_sud->execute(array($destination));
                                            while ($donnees = $reservation_bretagne_sud->fetch()) {
